function z = measurement_TF( x_tdoa, x_fdoa, v_fdoa, x_source, tdoa_ref_idx, fdoa_ref_idx, alpha_tdoa, alpha_fdoa)
...
% Parse inputs
if nargin < 5 || ~exist('tdoa_ref_idx','var')
    tdoa_ref_idx = [];
end
if nargin < 6 || ~exist('fdoa_ref_idx','var')
    fdoa_ref_idx = [];
end
...
if nargin < 7 || ~exist('alpha_tdoa','var')
    alpha_tdoa = [];
end

if nargin < 8 || ~exist('alpha_fdoa','var')
    alpha_fdoa = [];
end
