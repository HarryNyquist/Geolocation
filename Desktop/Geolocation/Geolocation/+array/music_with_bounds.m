function [P,psi_vec] = music_with_bounds(x,v,D,min_psi, max_psi,N_pts)
...
%           eigenvalue]
%   min_psi Minimum steering angle (degrees)
%   max_psi Maximum steering angle (degrees)
...
min_psi_rad = deg2rad(min_psi);
max_psi_rad = deg2rad(max_psi);
psi_vec = linspace(min_psi_rad, max_psi_rad, N_pts);
P = zeros(1,N_pts);
for idx_pt = 1:N_pts
