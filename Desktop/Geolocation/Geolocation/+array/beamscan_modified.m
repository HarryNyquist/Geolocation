function [P,psi_vec] = beamscan_modified(x,v,psi_LS,N_pts) % Modified _Beam scan function---function [P,psi_vec] = beamscan(x,v,psi_max,N_pts)
...
if nargin < 3 || isempty(psi_LS)  % if nargin < 3 || isempty(psi_max)
    psi_LS = pi/2;    % psi_max = pi/2;
end
