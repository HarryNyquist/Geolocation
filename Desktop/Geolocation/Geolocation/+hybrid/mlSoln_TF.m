function [x_est,A,x_grid] = mlSoln_TF(x_tdoa,x_fdoa,v_fdoa,zeta,C,x_ctr,search_size,epsilon,tdoa_ref_idx,fdoa_ref_idx)
...
ell = @(x) hybrid.loglikelihood_TF(x_tdoa,x_fdoa,v_fdoa,zeta,C,x,tdoa_ref_idx,fdoa_ref_idx);

% Call the util function
[x_est,A,x_grid] = utils.mlSoln_TF(ell,x_ctr,search_size,epsilon);
