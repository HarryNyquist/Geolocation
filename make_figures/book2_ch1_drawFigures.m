...
% Find Isochrones
xiso1 = tdoa.drawIsochrone(x_sensor1,x_sensor2,r2-r1,1000,5*1e3);
xisop1 = tdoa.drawIsochrone(x_sensor1, x_sensor2, r2-r1+epsrdoa, 1000, 5*1e3);
xisom1 = tdoa.drawIsochrone(x_sensor1, x_sensor2, r2-r1-epsrdoa, 1000, 5*1e3);
isoFill1 = cat(2,xisop1,fliplr(xisom1),xisop1(:,1));

xiso2 = tdoa.drawIsochrone(x_sensor2,x_sensor3,r3-r2,1000,5*1e3);
xisop2 = tdoa.drawIsochrone(x_sensor2, x_sensor3, r3-r2+epsrdoa, 1000, 5*1e3);
xisom2 = tdoa.drawIsochrone(x_sensor2, x_sensor3, r3-r2-epsrdoa, 1000, 5*1e3);
...
% Text labels
text(x_sensor(1,1)-.2,x_sensor(2,1)-.2,'$S_1$','FontSize',12);
text(x_sensor(1,2)-.2,x_sensor(2,2)-.2,'$S_2$','FontSize',12);
text(x_sensor(1,3)-.2,x_sensor(2,3)-.2,'$S_3$','FontSize',12);
